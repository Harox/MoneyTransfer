...
class MetasTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $metas = [
            ...
            // Crypto Send
            ['url' => 'crpto/send/{walletCurrencyCode}/{walletId}', 'title' => 'Send Crypto', 'description' => 'Send Crypto', 'keywords' => ''],
            ['url' => 'crpto/send/confirm', 'title' => 'Send Crypto Confirm', 'description' => 'Send Crypto Confirm', 'keywords' => ''],
            ['url' => 'crpto/send/success', 'title' => 'Send Crypto Success', 'description' => 'Send Crypto Success', 'keywords' => ''],

            // Crypto Receive
            ['url' => 'crpto/receive/{walletCurrencyCode}/{walletId}', 'title' => 'Receive Crypto', 'description' => 'Receive Crypto', 'keywords' => ''],

            // Crypto Disabled
            ['url' => 'user/crypto/preference-disabled', 'title' => 'Crypto Disabled', 'description' => 'Crypto Disabled', 'keywords' => ''],
