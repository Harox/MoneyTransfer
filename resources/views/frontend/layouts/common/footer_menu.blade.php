                    ...
                    <form class="contact-form-area">
                        ...
                        <div class="playStore">
                            @foreach(getAppStoreLinkFrontEnd() as $app)
                                @if (!empty($app->logo))
                                    <a href="{{$app->link}}"><img src="{{url('public/uploads/app-store-logos/'.$app->logo)}}" class="img-responsive" width="125" height="50" style="padding-left:5px;padding-right: 5px;width:50%; float:left;height: 39px;"/></a>
                                @else
