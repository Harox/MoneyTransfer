                                                ...
                                                <span class="card-title">
                                                  {{-- @if($value['id']==1)
                                                    @if (!empty(getCompanyLogoWithoutSession()))
                                                      <img src='{{asset("public/images/logos/".getCompanyLogoWithoutSession())}}' width="288" height="90" alt="Logo">
                                                    @else
                                                      <img src='{{asset("public/uploads/userPic/default-logo.jpg")}}' width="288" height="90">
                                                    @endif
                                                  @else
