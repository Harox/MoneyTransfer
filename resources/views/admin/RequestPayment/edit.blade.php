										...
										<div class="panel-body">
											...
											@if ($request_payments->amount)
							                    <div class="form-group">
													...
													<div class="col-sm-6">
													  <p class="form-control-static pull-left">{{  moneyFormat($request_payments->currency->symbol, formatNumber($request_payments->amount)) }}</p>
													</div>
												</div>
											@endif
							                    ...
							                    <div class="form-group total-deposit-feesTotal-space">
													...
													<div class="col-sm-6">
													  <p class="form-control-static pull-left">{{  moneyFormat($request_payments->currency->symbol, formatNumber($request_payments->accept_amount)) }}</p>
													</div>
												</div>
							                    ...
							                    <div class="form-group total-deposit-feesTotal-space-request-payment">
													...
													<div class="col-sm-6">
													  <p class="form-control-static pull-left">{{ isset($transaction) ? moneyFormat($request_payments->currency->symbol, formatNumber($transaction->charge_percentage + $transaction->charge_fixed)) :  moneyFormat($request_payments->currency->symbol, formatNumber(0.00)) }}</p>
													</div>
												</div>
							                    ...
							                    <div class="form-group total-deposit-space-request-payment">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($request_payments->currency->symbol, formatNumber($total)) }}</p>
													</div>
												</div>
