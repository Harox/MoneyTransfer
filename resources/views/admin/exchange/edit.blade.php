										...
										<div class="panel-body">
											...
											@if ($exchange->amount)
							                    <div class="form-group">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($exchange->currency->symbol, formatNumber($exchange->amount)) }}</p>
													</div>
												</div>
											@endif
											...
											@if (isset($exchange->fee))
							                    <div class="form-group total-deposit-feesTotal-space">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($exchange->currency->symbol, formatNumber($exchange->fee)) }}</p>
													</div>
												</div>
											@endif
											...
											@if (isset($total))
							                    <div class="form-group total-deposit-space">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($exchange->currency->symbol, formatNumber($total)) }}</p>
													</div>
												</div>
											@endif
