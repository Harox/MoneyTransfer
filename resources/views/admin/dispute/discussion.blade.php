		...
		<div class="box-body">
			<form action="{{url('admin/dispute/reply')}}" id="reply" method="post" enctype="multipart/form-data">
				...
				<div class="form-group col-sm-12 text-right">
					<button type="submit" class="btn btn-primary" id="dispute-reply"><i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="dispute-reply-text">Submit</span></button>
				</div>
			...
			<div class="well well-sm">
				<div class="media">
				    ...
				    <div class="media-body">
				      <h4><a href="{{ url('admin/admin-user/edit/'. $dispute->claimant->id)}}">{{$dispute->claimant->first_name .' '.$dispute->claimant->last_name}}</a> <small><i>{{ dateFormat($dispute->created_at) }}</i></small> &nbsp;
				      </h4>
