          ...
          <div class="box-body">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        value="{{ isset($feeslimit->max_limit) ? number_format((float)$feeslimit->max_limit, $preference['decimal_format_amount'], '.', '') : '' }}"
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        value="{{ isset($feeslimit->charge_percentage) ?  number_format((float)$feeslimit->charge_percentage, $preference['decimal_format_amount'], '.', '') :
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        value="{{ isset($feeslimit->charge_fixed) ? number_format((float)$feeslimit->charge_fixed, $preference['decimal_format_amount'], '.', '') :
                        number_format((float)0.00000000, $preference['decimal_format_amount'], '.', '') }}"
