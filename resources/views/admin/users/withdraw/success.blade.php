                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="text-center"><p><strong>Payout Completed successfully</strong></p></div>
                                    <h5 class="text-center mt10">Amount : {{ moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['subtotal'])) }}</h5>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        ...
                        <div style="margin-left: 0 auto">
                            <div style="float: left;">
                                  <a href="{{url("admin/users/withdraw/print/".$transInfo['id'])}}" target="_blank" class="btn button-secondary"><strong>Print</strong></a>
                            </div>
