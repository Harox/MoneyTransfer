                        ...
                        <div style="margin-left: 0 auto">
                            <div style="float: left;">
                                <a href="#" class="admin-user-withdraw-confirm-back-link">
                                    <button class="btn button-secondary admin-user-withdraw-confirm-back-btn"><strong><i class="fa fa-angle-left"></i>&nbsp;&nbsp;Back</strong></button>
                                </a>
                            </div>
                            <div style="float: right;">
                                <form action="{{ url('admin/users/withdraw/storeFromAdmin') }}" style="display: block;" method="POST" accept-charset="UTF-8" id="admin-user-withdraw-confirm" novalidate="novalidate">
                                    ...
                                    <button type="submit" class="btn button-secondary" id="withdrawal-confirm">
