...
@section('title', 'Crypto Receive Success')
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="text-center"><p><strong> {{ $walletCurrencyCode }} Received Successfully.</strong></p></div>
                                ...
                                <h5 class="text-center mt10">Received Amount : {{ moneyFormat($currencySymbol, number_format($amount, 8, '.', '')) }}</h5>
                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            ...
                            <div style="float: right;">
                                <a href="{{url("admin/users/crypto/receive/$userId")}}" class="btn button-secondary"><strong>Receive {{ $walletCurrencyCode }} Again</strong></a>
                            </div>
                        </div>
                    </div>
                </div>
