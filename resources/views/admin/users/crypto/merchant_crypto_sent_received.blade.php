                    ...
                    <tr>
                        <td>
                            <table style="margin-top:20px;">
                                <tr>
                                    {{-- TODO: translation --}}
                                    <td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">Receiver Address</td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <table style="margin-top:20px; width:300px;">
                                ...
                                <tr>
                                    {{-- TODO: translation --}}
                                    <td style="font-size:15px; color:#000000;">Sent Amount</td>
                                ...
                                <tr style="padding-bottom:10px;">
                                    {{-- TODO: translation --}}
                                    <td style="font-size:15px; color:#000000;">Network Fee</td>
                    ...
                    <tr>
                        <td>
                            <table style="margin-top:20px;">
                                <tr>
                                    {{-- TODO: translation --}}
                                    <td style="font-size:16px; color:#000000; line-height:25px; font-weight:bold;">Sender Address</td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <table style="margin-top:20px; width:300px;">
                                ...
                                <tr>
                                    {{-- TODO: translation --}}
                                    <td style="font-size:15px; color:#000000;">Received Amount</td>
                                    <td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transaction->currency->symbol, $transaction->subtotal) }}</td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="border-top:1px solid #eaeaea; padding-top:0; margin-bottom:3px;"></td>
