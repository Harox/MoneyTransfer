    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="pull-right">
                ...
                @if ($getUserWalletCryptoapiLogs->count() > 0 && $getCurrenciesPreference->value == "fiat_and_crypto")
                    <!-- Crypto Send -->
                    <a style="margin-top: 15px;" href="{{ url('admin/users/crypto/send/'.$users->id) }}" class="btn button-secondary btn-flat">Crypto Send</a>
                    &nbsp;&nbsp;&nbsp;
                    <!-- Crypto Receive -->
                    <a style="margin-top: 15px;" href="{{ url('admin/users/crypto/receive/'.$users->id) }}" class="btn button-secondary btn-flat">Crypto Receive</a>
                @endif
