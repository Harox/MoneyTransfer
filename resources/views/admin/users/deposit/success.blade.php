                    ...
                    <div class="col-md-7">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <h5 class="text-center mt10">Deposit Amount : {{ moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['subtotal'])) }}</h5>
                    ...
                    <div class="col-md-7">
                        <div style="margin-left: 0 auto">
                            <div style="float: left;">
                                  <a href="{{url("admin/users/deposit/print/".$transInfo['id'])}}" target="_blank" class="btn button-secondary"><strong>Print</strong></a>
                            </div>
