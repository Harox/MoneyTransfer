                ...
                <div class="box box-body">
					...
					<div class="col-md-3">
                        ...
                        <div class="small-box bg-aqua">
                            <div class="inner">
                                <h3>{{ moneyFormat($defaultCurrency->symbol, formatNumber($this_month_revenue)) }}</h3>
                                <p>PROFIT THIS MONTH</p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-envelope-o"></i>
                            </div>
                            <a href="{{ url('admin/tickets/list') }}" class="small-box-footer">More info <i
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="small-box bg-green">
                            ...
                            <a href="{{ url('admin/disputes') }}" class="small-box-footer">More info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><span style="margin-left: 14px;">Total Profit</span><span
                                                style="margin-left: 72px;">{{ moneyFormat($defaultCurrency->symbol, formatNumber($this_week_revenue)) }}</span>
                                        </h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-deposit" role="progressbar"
                                                    aria-valuenow="{{ $this_week_deposit_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $this_week_deposit_percentage; ?>%'>
                                                    <span class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-withdrawal" role="progressbar"
                                                    aria-valuenow="{{ $this_week_withdrawal_percentage }}"
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-transfer" role="progressbar"
                                                    aria-valuenow="{{ $this_week_transfer_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $this_week_transfer_percentage; ?>%'>
                                                    <span class="">
                                ...
                                <div class="tab-pane" id="tab_2">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><span style="margin-left: 14px;">Total Profit</span><span
                                                style="margin-left: 72px;">{{ moneyFormat($defaultCurrency->symbol, formatNumber($last_week_revenue)) }}</span>
                                        </h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-deposit" role="progressbar"
                                                    aria-valuenow="{{ $last_week_deposit_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $last_week_deposit_percentage; ?>%'>
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-withdrawal" role="progressbar"
                                                    aria-valuenow="{{ $last_week_withdrawal_percentage }}"
                                                    aria-valuemin="0" aria-valuemax="100"
                                                    style='width:<?php echo $last_week_withdrawal_percentage; ?>%'>
                                                    <span class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-transfer" role="progressbar"
                                                    aria-valuenow="{{ $last_week_transfer_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $last_week_transfer_percentage; ?>%'>
                                                    <span class="">
                                ...
                                <div class="tab-pane" id="tab_3">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><span style="margin-left: 14px;">Total Profit</span><span
                                                style="margin-left: 72px;">{{ moneyFormat($defaultCurrency->symbol, formatNumber($this_month_revenue)) }}</span>
                                        </h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-deposit" role="progressbar"
                                                    aria-valuenow="{{ $this_month_deposit_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $this_month_deposit_percentage; ?>%'>
                                                    <span class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-withdrawal" role="progressbar"
                                                    aria-valuenow="{{ $this_month_withdrawal_percentage }}"
                                                    aria-valuemin="0" aria-valuemax="100"
                                                    style='width:<?php echo $this_month_withdrawal_percentage; ?>%'>
                                                    <span class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-transfer" role="progressbar"
                                                    aria-valuenow="{{ $this_month_transfer_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $this_month_transfer_percentage; ?>%'>
                                ...
                                <div class="tab-pane" id="tab_4">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><span style="margin-left: 14px;">Total Profit</span><span
                                                style="margin-left: 72px;">{{ moneyFormat($defaultCurrency->symbol, formatNumber($last_month_revenue)) }}</span>
                                        </h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-deposit" role="progressbar"
                                                    aria-valuenow="{{ $last_month_deposit_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $last_month_deposit_percentage; ?>%'>
                                                    <span class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-withdrawal" role="progressbar"
                                                    aria-valuenow="{{ $last_month_withdrawal_percentage }}"
                                                    aria-valuemin="0" aria-valuemax="100"
                                                    style='width:<?php echo $last_month_withdrawal_percentage; ?>%'>
                                                    <span class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar progress-bar-transfer" role="progressbar"
                                                    aria-valuenow="{{ $last_month_transfer_percentage }}" aria-valuemin="0"
                                                    aria-valuemax="100" style='width:<?php echo $last_month_transfer_percentage; ?>%'>
                                                    <span class="">
                    ...
                    <div class="box box-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="{{ url('admin/merchants') }}" class="small-box-footer">More info <i
                                        class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($latestTicket as $item)
                                            <tr class="text-left">
                                                <td style="width: 35%;"><a
                                                        href='{{ url("admin/tickets/reply/$item->id") }}'>{{ $item->subject }}</a>
                                                </td>
                                                <td style="width: 20%;"><a
                                                        href='{{ url("admin/users/edit/$item->user_id") }}'>{{ $item->first_name . ' ' . $item->last_name }}</a>
                                                </td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($latestDispute as $item)
                                            <tr class="text-left">
                                                <td style="width: 40%;"><a
                                                        href='{{ url("admin/dispute/discussion/$item->id") }}'>{{ $item->title }}</a>
                                                </td>
                                                <td style="width: 30%;"><a
                                                        href='{{ url("admin/users/edit/$item->claimant_id") }}'>{{ $item->first_name . ' ' . $item->last_name }}</a>
                                                </td>
                            ...
                            @foreach ($wallets as $code => $wallet_amount)
                                ...
                                <div style="min-height:45px;border-bottom: 1px solid gray;padding: 5px 0px;">
                                    <div style="width:60%;float: left;">
                                        <div style="min-height: 25px;">{{ $code }}</div>
