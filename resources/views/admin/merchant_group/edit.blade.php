                ...
                <form method="POST" action="{{ url('admin/settings/edit-merchant-group/'. $merchantGroup->id) }}" class="form-horizontal" id="merchant-group-edit-form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="fee" class="form-control" value="{{ number_format((float)$merchantGroup->fee, $preference['decimal_format_amount'], '.', '') }}" placeholder="Edit fee" id="fee" oninput="restrictNumberToPrefdecimal(this)">
                                @if($errors->has('fee'))
                                    <span class="help-block">
