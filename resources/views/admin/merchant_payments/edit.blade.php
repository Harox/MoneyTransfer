											...
											<div class="panel-body">
												...
												@if ($merchant_payment->amount)
								                    <div class="form-group">
														...
														<div class="col-sm-6">
														  <p class="form-control-static">{{  moneyFormat($merchant_payment->currency->symbol, formatNumber($merchant_payment->amount)) }}</p>
														</div>
													</div>
												@endif
							                    ...
							                    <div class="form-group total-deposit-feesTotal-space">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($merchant_payment->currency->symbol, formatNumber($feesTotal)) }}</p>
													</div>
												</div>
												...
												@if (isset($total))
								                    <div class="form-group total-deposit-space">
														...
														<div class="col-sm-6">
														  <p class="form-control-static">{{  moneyFormat($merchant_payment->currency->symbol, formatNumber($total)) }}</p>
														</div>
													</div>
												@endif
											...
											@if (!isset($transactionOfRefunded->refund_reference))
												<div class="col-md-1">
													<button type="submit" class="btn button-secondary pull-right" id="merchant_payment_edit">
		                                                <i class="fa fa-spinner fa-spin" style="display: none;"></i> <span id="merchant_payment_edit_text">Update</span>
		                                            </button>
												</div>
											@endif
										</div>
