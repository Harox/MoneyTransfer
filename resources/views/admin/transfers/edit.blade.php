										...
										<div class="panel-body">
											...
											@if ($transfer->amount)
							                    <div class="form-group">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($transfer->currency->symbol, formatNumber($transfer->amount)) }}</p>
													</div>
												</div>
											@endif
						                    ...
						                    <div class="form-group total-deposit-feesTotal-space">
												...
												<div class="col-sm-6">
												  <p class="form-control-static">{{  moneyFormat($transfer->currency->symbol, formatNumber($transfer->fee)) }}</p>
												</div>
											</div>
											...
											@if (isset($total))
							                    <div class="form-group total-deposit-space">
													...
													<div class="col-sm-6">
													  <p class="form-control-static">{{  moneyFormat($transfer->currency->symbol, formatNumber($total)) }}</p>
													</div>
												</div>
											@endif
