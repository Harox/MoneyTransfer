      ...
      <div class="box box-info">
        ...
        <form method="POST" action="{{ url('admin/settings/edit_country/'.$result->id) }}" class="form-horizontal" id="edit_country_form">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="is_default">Default</label>
              <div class="col-sm-6">
              <p class="form-control-static"><span class="label label-danger">Default Yes in not allowed to change </span></p><p><span>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="is_default">Default</label>
              <div class="col-sm-6">
                  <select class="select2 form-control" name="is_default" id="is_default">
