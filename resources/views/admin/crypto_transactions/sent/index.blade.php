...
@section('title', 'Crypto Sent Transactions')
...
@section('page_content')
    <div class="box">
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('admin/crypto-sent-transactions') }}" method="GET">
            ...
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-8">
                                <h3 class="panel-title">All Crypto Sent Transactions</h3>
                            </div>
                            <div class="col-md-4">
    ...
    <script type="text/javascript">
        ...
        $('#user_input').autocomplete(
        {
            source:function(req,res)
            {
                ...
                {
                    $.ajax({
                        url:'{{url('admin/crypto-sent-transactions/search/user')}}',
                        dataType:'json',
                        type:'get',
                        data:{
                            search:req.term
        ...
        $(document).on('click', '#csv', function (e)
        {
            ...
            window.location = SITE_URL+"/admin/crypto-sent-transactions/csv?startfrom="+startfrom
            +"&endto="+endto
            +"&status="+status
            +"&currency="+currency
            +"&user_id="+user_id;
        ...
        $(document).on('click', '#pdf', function (e)
        {
            ...
            var currency = $('#currency').val();
            var user_id = $('#user_id').val();
            window.location = SITE_URL+"/admin/crypto-sent-transactions/pdf?startfrom="+startfrom
            +"&endto="+endto
            +"&status="+status
            +"&currency="+currency
            +"&user_id="+user_id;
