                        ...
                        <div class="card">
                            ...
                            <div class="wap-wed mt20 mb20">
                                ...
                                <div class="form-group">
                                    <label>@lang('message.dashboard.send-request.common.receivername')</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control wallet" name="wallet">
                                                {{-- @foreach($currencies as $currencie)
                                                        <option >{{ $currencie->code }}</option>
                                                @endforeach --}}

                                                @foreach($currencies as $currencie)
                                                        <option name="currency_id" id="currency_id" value="{{ $currencie->id }}"  }}>{{ $currencie->code  }}</option>
                                                @endforeach
