                        ...
                        <div class="card">
                            ...
                            <div class="wap-wed mt20 mb20">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="amount" id="amount" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" placeholder="0.00" type="text" oninput="restrictNumberToPrefdecimal(this)">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-cust col-12" id="withdrawal-create">
