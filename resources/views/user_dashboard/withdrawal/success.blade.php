                ...
                <div class="col-md-7 col-xs-12 mb20 marginTopPlus">
                    <div class="card">
                        ...
                        <div class="card-footer" style="margin-top: 10px">
                            <div class="text-center">
                                <a href="{{url('withdrawal-money/print')}}/{{$transactionId}}" target="_blank" class="btn btn-cust"><strong>@lang('message.dashboard.vouchers.success.print')</strong>
                                </a>

                                <a href="{{url('payout')}}" class="btn btn-cust payout-again">
