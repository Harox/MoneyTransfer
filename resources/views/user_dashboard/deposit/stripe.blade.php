                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{URL::to('deposit/stripe_payment_store')}}" method="post" id="payment-form">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        {{-- <button class="btn btn-cust float-left" style="margin-top:10px;" type="submit" id="deposit-stripe-submit-btn">
                                            @lang('message.form.submit')
                                        </button> --}}
                                        <button type="submit" class="btn btn-cust float-left" style="margin-top:10px;" id="deposit-stripe-submit-btn">
